...
- Этап 3. Интерпретатор и операции с памятью - Текущий
...
### 2 этап
- Реализован транслятор из промежуточного представления в машинное
- Результат ассемблирования записывается в двоичный файл
- На экран выводится размер получившегося файла в байтах
- В режиме тестирования на экран выводится результат ассемблирования в байтовом формате, как в тесте из спецификации УВМ
- Создан файл на языке ассемблера, результат трансляции которого соответствует всем тестовым байтовым последовательностям из спецификации УВМ 
